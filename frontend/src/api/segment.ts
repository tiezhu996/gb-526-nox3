...
import type { CreateExposureSegment, ExposureSegment, InsertExposureSegment } from '@/types/segment'
...
export const insertSegment = (planId: number, input: InsertExposureSegment) => request<ExposureSegment[]>(`/plans/${planId}/segments/insert`, { method: 'POST', body: JSON.stringify(input) })
