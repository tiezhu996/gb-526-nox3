...
export const insertSegment = (planId: number, input: CreateExposureSegment) => request<ExposureSegment[]>(`/plans/${planId}/segments/insert`, { method: 'POST', body: JSON.stringify(input) })
